...
export default function Header() {
  ...
  return (
    <div className="justify-center w-full overflow-x-hidden border-black border-y-2">
    
    <div className="relative">
      <Hero />
      <div className={`justify-center w-full border-black 2xl:border-2  border-y-2`} id="head">
        <div className="flex items-center justify-between h-16 pl-4 border-black border-b-1 border-t-1 md:pl-14">
          <Link href="/">
          ...
          <div className="flex items-center space-x-10 font-light text-md">
            ...
            >
              <span className="font-normal tracking-wider text-md">
                SIGN IN
              </span>
            </Link>
          </div>
